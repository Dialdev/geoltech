...
/*ZDUyZmZNDMyNmMyZTQwZTdkNDVjZGVmMTcwOGY2ZWRjNDVmOTI=*/$GLOBALS['____1843069935']= array(base64_decode(''.'ZG'.'VmaW5'.'l'));if(!function_exists(__NAMESPACE__.'\\___116060253')){function ___116060253($_1678523356){static $_1084498590= false; if($_1084498590 == false) $_1084498590=array('RU5DT0'.'RF','WQ==');return base64_decode($_1084498590[$_1678523356]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1048613496){ return true;} public static function IsFeatureEditable($_1048613496){ return true;} public static function SetFeatureEnabled($_1048613496, $_832948807= true){} public static function SaveFeaturesSettings($_481036881, $_1409581006){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_864445745){} public static function ModifyFeaturesSettings($_864445745, $_345170964){} public static function IsFeatureInstalled($_1048613496){ return true;}} $GLOBALS['____1843069935'][0](___116060253(0), ___116060253(1));/**/			//Do not remove this
